...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/JaTochNietDan/cosmos-sdk/types/errors.Wrap",
		"github.com/JaTochNietDan/cosmos-sdk/types/errors.Wrapf",
		"github.com/JaTochNietDan/cosmos-sdk/types/errors.WithType",
